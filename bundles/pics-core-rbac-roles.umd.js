(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var MicrostrategyService = /** @class */ (function () {
        function MicrostrategyService(_storeservice) {
            var _this = this;
        ...
        MicrostrategyService.prototype.getLibraryDetails = function () {
            return this.httpService
                ...
                return response.data.map(function (mstr) { return ({
                    id: mstr.target.id,
    ...
    MicrostrategyService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: MicrostrategyService, deps: [{ token: DataStoreService }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ...
    var RbacService = /** @class */ (function () {
        ...
        RbacService.prototype.getAllPages = function (role_id) {
    ...
    var RolesComponent = /** @class */ (function () {
        ...
        RolesComponent.prototype.isAnyFormControlWithValue = function () {
            var formValue = this.roleForm.value;
            var avoidProperties = ['parentid'];
        ...
        RolesComponent.prototype.onInput = function (event, fieldtype, label, required) {
        ...
        RolesComponent.prototype.getLandingPage = function () {
            ...
            this.rolesService.getLandingPage('1').subscribe(function (res) {
                ...
                _this.dublicateLandingPage = __spreadArray([], __read(_this.landingPage));
        ...
        RolesComponent.prototype.clearSearch = function (event) {
        ...
        RolesComponent.prototype.onClickAddRole = function () {
            var _this = this;
        ...
        RolesComponent.prototype.clearPermission = function (event) {
            var inputElement = document.querySelector('.clearbox');
            if (inputElement) {
                inputElement.value = '';
            }
            this.permissions = this.originalPermissions;
        };
        RolesComponent.prototype.searchRolePermission = function (event) {
            var value = event.target.value.toLowerCase();
            this.permissions = this.originalPermissions.filter(function (a) { var _a; return (_a = a === null || a === void 0 ? void 0 : a.description) === null || _a === void 0 ? void 0 : _a.toLowerCase().startsWith(value); });
        };
        RolesComponent.prototype.getTabs = function () {
            var _this = this;
            this.items = [
                {
                    label: 'Permissions',
        ...
        RolesComponent.prototype.selectAllPage = function (index, event) {
            ...
            this.checkedRolesArr = this.permissions.filter(function (item) { return item.checked === true; });
        ...
        RolesComponent.prototype.resetReportDashboardList = function () {
        ...
        RolesComponent.prototype.delete = function (event, id, item) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            _d = this;
                            return [4 /*yield*/, this.mstrService.getLibraryDetails()];
                        case 1:
                            _d.reportDashboardList = _f.sent();
                            _e = this;
                            return [4 /*yield*/, this.mstrService.getLibraryDetails()];
                        case 2:
                            _e.duplicatereportDashboardList = _f.sent();
                            return [2 /*return*/];
                    }
                });
            });
        ...
        RolesComponent.prototype.searchLandingPageList = function (event) {
            var value = event.target.value.toLowerCase();
            this.dublicateLandingPage = this.landingPage.filter(function (a) { var _a; return (_a = a === null || a === void 0 ? void 0 : a.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().startsWith(value); });
        };
        RolesComponent.prototype.resetLandingPageList = function () {
            this.dublicateLandingPage = this.landingPage;
        };
        ...
        RolesComponent.prototype.getPageInformation = function () {
            var _this = this;
            this.permissionService.getAllPages(this.roleId).subscribe(function (res) {
        ...
        RolesComponent.prototype.updateMenuOrder = function () {
            ...
            this.permissionService.updateMenuOrder({ pages: this.reArrangedList }).subscribe(function (res) {
                ...
                if (Number(userRole) === _this.roleId) {
        ...
        RolesComponent.prototype.selectPolicyGroup = function () {
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: RolesComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.Injector }, { type: i1__namespace$1.FormBuilder }, { type: AlertService }, { type: MicrostrategyService }, { type: RbacService }, { type: DataStoreService }, { type: RbacService }]; } });
    ...
    RbacRolesComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: RbacRolesComponent, selector: "rbac-roles", inputs: { RBACORG: "RBACORG", PERMISSION: "PERMISSION", roleEvent: "roleEvent", INPUTVALIDATIONMETHOD: "INPUTVALIDATIONMETHOD" }, ngImport: i0__namespace, template: "\n      <roles></roles>\n  ", isInline: true, components: [{ type: RolesComponent, selector: "roles" }] });
    ...
    PicsRbacRolesModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsRbacRolesModule, providers: [RbacService, MicrostrategyService, http.HttpClient, AlertService, i17.ConfirmationService, PermissionStore,
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsRbacRolesModule, decorators: [{
                ...
                args: [{
                        ...
                        providers: [RbacService, MicrostrategyService, http.HttpClient, AlertService, i17.ConfirmationService, PermissionStore,
    ...
    RbacRolesModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: RbacRolesModule, declarations: [RbacRolesComponent], imports: [PicsRbacRolesModule,
            i8.DropdownModule], exports: [RbacRolesComponent] });
